...
plates.forEach(function (plateList) {

    var menuDiv = document.createElement("div");
    menuDiv.setAttribute('class', 'menu-body');

    var elements = document.createElement("p");
    elements.textContent = 'Day: ' + plateList.Day;
    menuDiv.appendChild(elements);

    var elements = document.createElement("p");
    elements.textContent = 'Plate: ' + plateList.Name;
    menuDiv.appendChild(elements);

    var elements = document.createElement("p");
    elements.textContent = 'Type: ' + plateList.Type;
    menuDiv.appendChild(elements);

    var elements = document.createElement("p");
    elements.textContent = 'Price: ' + plateList.Price + ' €';
    menuDiv.appendChild(elements);

    var elements = document.createElement("p");
    var elementsImag = document.createElement("img");
    elementsImag.setAttribute('src', plateList.img)
    elements.appendChild(elementsImag);

    menuDiv.appendChild(elements);

    document.getElementById("menu-content").appendChild(menuDiv);
