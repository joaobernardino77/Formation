...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t11 = space();
    			div2 = element("div");
    			add_location(h2, file$1, 48, 10, 1668);
    			attr_dev(div0, "class", "modal-header");
    			add_location(div0, file$1, 47, 8, 1630);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "placeholder", "Username");
    			attr_dev(input0, "id", "registerLoginInput");
    			add_location(input0, file$1, 52, 16, 1773);
    			add_location(br0, file$1, 53, 16, 1882);
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "placeholder", "Password");
    			attr_dev(input1, "id", "registerPasswordInput");
    			add_location(input1, file$1, 54, 16, 1904);
    			add_location(br1, file$1, 55, 16, 2020);
    			attr_dev(input2, "type", "text");
    			attr_dev(input2, "placeholder", "Email");
    			attr_dev(input2, "id", "registerEmailInput");
    			add_location(input2, file$1, 56, 16, 2042);
    			add_location(br2, file$1, 57, 16, 2148);
    			attr_dev(button, "id", "confirmRegisterBtn");
    			attr_dev(button, "type", "submit");
    			button.disabled = true;
    			add_location(button, file$1, 58, 16, 2170);
    			attr_dev(p, "id", "registerPWarning");
    			add_location(p, file$1, 59, 16, 2301);
    			add_location(form, file$1, 51, 12, 1749);
    			attr_dev(div1, "class", "modal-body");
    			add_location(div1, file$1, 50, 8, 1711);
    			attr_dev(div2, "class", "modal-footer");
    			add_location(div2, file$1, 62, 8, 2403);
    			set_style(div3, "margin-top", "10%");
    			set_style(div3, "text-align", "center");
    			add_location(div3, file$1, 46, 4, 1570);
    			attr_dev(div4, "id", "myModalRegister");
    			add_location(div4, file$1, 45, 0, 1538);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(input2, "input", /*handleWarging*/ ctx[0], false, false, false),
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const handleRegister = async event => {
    		...
    		let user = await registerUser({ email, password, username });
    		console.log(user);
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<RegisterModal> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a = element("a");
    			a.textContent = "here";
    			add_location(h2, file$2, 71, 10, 2244);
    			attr_dev(div0, "class", "modal-header");
    			add_location(div0, file$2, 70, 8, 2206);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "placeholder", "Email");
    			attr_dev(input0, "id", "loginInput");
    			add_location(input0, file$2, 75, 16, 2346);
    			add_location(br0, file$2, 76, 16, 2444);
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "placeholder", "Password");
    			attr_dev(input1, "id", "passwordInput");
    			add_location(input1, file$2, 77, 16, 2466);
    			add_location(br1, file$2, 78, 16, 2574);
    			attr_dev(button, "id", "loginBtn");
    			attr_dev(button, "type", "submit");
    			button.disabled = true;
    			add_location(button, file$2, 79, 16, 2596);
    			attr_dev(p0, "id", "pWarning");
    			add_location(p0, file$2, 80, 16, 2696);
    			add_location(form, file$2, 74, 12, 2322);
    			attr_dev(div1, "class", "modal-body");
    			add_location(div1, file$2, 73, 8, 2284);
    			attr_dev(a, "id", "registerBtn");
    			add_location(a, file$2, 84, 45, 2863);
    			add_location(p1, file$2, 84, 10, 2828);
    			attr_dev(div2, "class", "modal-footer");
    			add_location(div2, file$2, 83, 8, 2790);
    			set_style(div3, "margin-top", "10%");
    			set_style(div3, "text-align", "center");
    			add_location(div3, file$2, 69, 4, 2146);
    			attr_dev(div4, "id", "myModal");
    			add_location(div4, file$2, 68, 0, 2122);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    */
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<LoginModal> was created with unknown prop '${key}'`);
    	});
    ...
    async function scheduleUser({monday, tuesday, wednesday, thursday, friday, userToken}){
        const response = await axios$1.post(`${url}/schedules`,{
            monday,
            tuesday,
            wednesday,
            thursday,
    ...
    // (84:12) {#each mondayMeals as mondayPlate}
    function create_each_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file$3, 84, 16, 3976);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(84:12) {#each mondayMeals as mondayPlate}",
    		ctx
    	});
    ...
    // (91:12) {#each tuesdayMeals as tuesdayPlate}
    function create_each_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			option.value = option.__value;
    			add_location(option, file$3, 91, 16, 4290);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, option, anchor);
    			append_dev(option, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(91:12) {#each tuesdayMeals as tuesdayPlate}",
    		ctx
    	});
    ...
    // (98:14) {#each wednesdayMeals as wednesdayPlate}
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			option.value = option.__value;
    			add_location(option, file$3, 98, 16, 4624);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, option, anchor);
    			append_dev(option, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(98:14) {#each wednesdayMeals as wednesdayPlate}",
    		ctx
    	});
    ...
    // (105:14) {#each thursdayMeals as thursdayPlate}
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			option.value = option.__value;
    			add_location(option, file$3, 105, 16, 4957);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, option, anchor);
    			append_dev(option, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(105:14) {#each thursdayMeals as thursdayPlate}",
    		ctx
    	});
    ...
    // (112:14) {#each fridayMeals as fridayPlate}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			option.value = option.__value;
    			add_location(option, file$3, 112, 16, 5278);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, option, anchor);
    			append_dev(option, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(112:14) {#each fridayMeals as fridayPlate}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$3, 77, 10, 3695);
    			attr_dev(div0, "class", "modal-header");
    			add_location(div0, file$3, 76, 8, 3657);
    			add_location(p0, file$3, 80, 10, 3784);
    			option0.__value = "0";
    			option0.value = option0.__value;
    			add_location(option0, file$3, 82, 12, 3877);
    			attr_dev(select0, "id", "mondaySelect");
    			if (/*mondaySelected*/ ctx[0] === void 0) add_render_callback(() => /*select0_change_handler*/ ctx[12].call(select0));
    			add_location(select0, file$3, 81, 10, 3809);
    			add_location(p1, file$3, 87, 10, 4091);
    			option1.__value = "0";
    			option1.value = option1.__value;
    			add_location(option1, file$3, 89, 12, 4189);
    			attr_dev(select1, "id", "tuesdaySelect");
    			if (/*tuesdaySelected*/ ctx[1] === void 0) add_render_callback(() => /*select1_change_handler*/ ctx[13].call(select1));
    			add_location(select1, file$3, 88, 12, 4119);
    			add_location(p2, file$3, 94, 12, 4411);
    			option2.__value = "0";
    			option2.value = option2.__value;
    			add_location(option2, file$3, 96, 14, 4517);
    			attr_dev(select2, "id", "wednesdaySelect");
    			if (/*wednesdaySelected*/ ctx[2] === void 0) add_render_callback(() => /*select2_change_handler*/ ctx[14].call(select2));
    			add_location(select2, file$3, 95, 12, 4441);
    			add_location(p3, file$3, 101, 12, 4749);
    			option3.__value = "0";
    			option3.value = option3.__value;
    			add_location(option3, file$3, 103, 14, 4852);
    			attr_dev(select3, "id", "thursdaySelect");
    			if (/*thursdaySelected*/ ctx[3] === void 0) add_render_callback(() => /*select3_change_handler*/ ctx[15].call(select3));
    			add_location(select3, file$3, 102, 12, 4778);
    			add_location(p4, file$3, 108, 12, 5080);
    			option4.__value = "0";
    			option4.value = option4.__value;
    			add_location(option4, file$3, 110, 14, 5177);
    			attr_dev(select4, "id", "fridaySelect");
    			if (/*fridaySelected*/ ctx[4] === void 0) add_render_callback(() => /*select4_change_handler*/ ctx[16].call(select4));
    			add_location(select4, file$3, 109, 12, 5107);
    			add_location(br, file$3, 115, 12, 5397);
    			attr_dev(p5, "id", "totalPrice");
    			add_location(p5, file$3, 116, 12, 5416);
    			attr_dev(button, "id", "scheduleBtn");
    			add_location(button, file$3, 117, 12, 5473);
    			attr_dev(div1, "class", "modal-body");
    			add_location(div1, file$3, 79, 8, 3748);
    			add_location(p6, file$3, 120, 10, 5611);
    			attr_dev(div2, "class", "modal-footer");
    			add_location(div2, file$3, 119, 8, 5573);
    			set_style(div3, "margin-top", "10%");
    			set_style(div3, "text-align", "center");
    			add_location(div3, file$3, 75, 4, 3597);
    			attr_dev(div4, "id", "scheduleModal");
    			add_location(div4, file$3, 74, 0, 3567);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    */
    		var monday = mondaySelect.options[mondaySelect.selectedIndex].text === "Select"
    		? ""
    		: mondaySelect.options[mondaySelect.selectedIndex].text;

    		var tuesday = tuesdaySelect.options[tuesdaySelect.selectedIndex].text === "Select"
    		? ""
    		: tuesdaySelect.options[tuesdaySelect.selectedIndex].text;

    		var wednesday = wednesdaySelect.options[wednesdaySelect.selectedIndex].text === "Select"
    		? ""
    		: wednesdaySelect.options[wednesdaySelect.selectedIndex].text;

    		var thursday = thursdaySelect.options[thursdaySelect.selectedIndex].text === "Select"
    		? ""
    		: thursdaySelect.options[thursdaySelect.selectedIndex].text;

    		var friday = fridaySelect.options[fridaySelect.selectedIndex].text === "Select"
    		? ""
    		: fridaySelect.options[fridaySelect.selectedIndex].text;

    		var user = JSON.parse(localStorage.getItem("user"));
    		var userToken = user.jwt;

    		const response = await scheduleUser({
    			monday,
    			tuesday,
    			wednesday,
    			thursday,
    ...
    */
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<ScheduleModal> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$4, 60, 4, 1377);
    			attr_dev(a0, "href", "#menu");
    			add_location(a0, file$4, 67, 8, 1554);
    			add_location(li0, file$4, 66, 8, 1540);
    			attr_dev(a1, "href", "#about");
    			add_location(a1, file$4, 70, 8, 1635);
    			add_location(li1, file$4, 69, 8, 1621);
    			attr_dev(a2, "id", "login");
    			attr_dev(a2, "style", a2_style_value = `display: ${/*showLogin*/ ctx[0]};`);
    			add_location(a2, file$4, 73, 8, 1718);
    			add_location(li2, file$4, 72, 8, 1704);
    			attr_dev(a3, "id", "schedule");
    			attr_dev(a3, "style", a3_style_value = `display: ${/*showSchedule*/ ctx[1]};`);
    			add_location(a3, file$4, 76, 8, 1839);
    			add_location(li3, file$4, 75, 8, 1825);
    			attr_dev(a4, "id", "logout");
    			attr_dev(a4, "style", a4_style_value = `display: ${/*showLogout*/ ctx[2]};`);
    			add_location(a4, file$4, 79, 8, 1972);
    			add_location(li4, file$4, 78, 8, 1958);
    			add_location(ul, file$4, 65, 4, 1526);
    			attr_dev(nav, "id", "main-navigation");
    			add_location(nav, file$4, 64, 4, 1494);
    			add_location(header, file$4, 58, 0, 1344);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p2, file$6, 13, 8, 324);
