...
<div id="scheduleModal">
    <div style="margin-top: 10%; text-align: center;">
        ...
        <div class="modal-body">
          <p>Monday</p>
          <select bind:value={mondaySelected} id="monday">
          ...
          <p>Tuesday</p>
            <select bind:value={tuesdaySelected} id="tuesday">
            <option value="0">Select</option>
            ...
            <p>Wednesday</p>
            <select bind:value={wednesdaySelected} id="wednesday">
              <option value="0">Select</option>
            ...
            <p>Thursday</p>
            <select bind:value={thursdaySelected} id="thursday">
              <option value="0">Select</option>
            ...
            <p>Friday</p>
            <select bind:value={fridaySelected} id="friday">
              <option value="0">Select</option>
